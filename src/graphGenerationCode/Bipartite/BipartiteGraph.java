...
public class BipartiteGraph
{
	public static void main(String[] args) throws Exception
	{
		...
		System.out.print("Enter number of nodes on the source side: \t");
		 n = Integer.parseInt(args[0]); // Assuming n is the first command line argument

		System.out.print("Enter number of nodes on the sink side: \t");
		 m = Integer.parseInt(args[1]); // Assuming m is the second command line argument

		System.out.print("Enter max probability: \t\t\t\t");
		 maxProbability = Double.parseDouble(args[2]); // Assuming maxProbability is the third command line argument
		...
		System.out.print("Enter minimum capacity: \t\t\t");
		 minCapacity = Integer.parseInt(args[3]); // Assuming minCapacity is the fourth command line argument

		System.out.print("Enter maximum capacity: \t\t\t");
		 maxCapacity = Integer.parseInt(args[4]); // Assuming maxCapacity is the fifth command line argument

		System.out.print("Enter the output file name: \t\t\t");
		String fileName = args[5] + ".txt"; // Assuming fileName is the sixth command line argument
