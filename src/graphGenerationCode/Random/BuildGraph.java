package graphGenerationCode.Random;//Zane,Yogi,Nick,Jodie
...
public class BuildGraph
{
	...
	{
		if (args.length >= 7) {
			System.out.println("Usage: java YourClassName <graph_name> <project_path> <arg1> <arg2> <arg3> <arg4>");
		} else {
			...
			int arg4 = Integer.parseInt(args[5]);

			// Call the method with command-line arguments
			BuildGraph(graphName, projectPath, arg1, arg2, arg3, arg4);
		}


	}
	private static void BuildGraph(String fileName, String directory, int vertices, int dense, int maxCapacity, int minCapacity)
	{
		Random random = new Random();
		try
		{
			String dirName = directory;//
			if (dirName.strip().equals(""))
			{
				dirName = ".";
			}
